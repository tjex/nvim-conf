...
Group.new("@markup.heading.1.markdown", c.gray_3, nil, s.underline)
Group.new("@markup.heading.2.markdown", c.gray_3, nil, s.underline)
Group.new("@markup.heading.3.markdown", c.gray_3, nil, s.underline)
Group.new("@markup.heading.4.markdown", c.gray_3, nil, s.underline)
Group.new("@markup.heading.5.markdown", c.gray_3, nil, s.underline)
Group.new("@markup.heading.6.markdown", c.gray_3, nil, s.underline)
